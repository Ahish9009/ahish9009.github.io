...
silent only
silent tabonly
cd ~/Desktop/Ahish/web-dev/ahish9009.github.io
...
wincmd w
argglobal
if bufexists("js/script2.js") | buffer js/script2.js | else | edit js/script2.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
setlocal wrapmargin=0
silent! normal! zE
let s:l = 98 - ((13 * winheight(0) + 7) / 14)
if s:l < 1 | let s:l = 1 | endif
exe s:l
normal! zt
98
...
wincmd w
argglobal
if bufexists("css/style-photography.css") | buffer css/style-photography.css | else | edit css/style-photography.css | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
...
exe 'vert 4resize ' . ((&columns * 92 + 92) / 185)
tabnext 1
badd +1 photography.html
badd +1 css/style-photography.css
badd +0 js/script2.js
