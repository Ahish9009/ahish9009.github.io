...
silent only
silent tabonly
cd ~/Desktop/Ahish/web-dev/bootstrap
...
exe 'vert 1resize ' . ((&columns * 116 + 92) / 185)
exe '2resize ' . ((&lines * 11 + 20) / 41)
exe 'vert 2resize ' . ((&columns * 116 + 92) / 185)
exe 'vert 3resize ' . ((&columns * 68 + 92) / 185)
argglobal
let s:cpo_save=&cpo
set cpo&vim
...
wincmd w
argglobal
if bufexists("script1.js") | buffer script1.js | else | edit script1.js | endif
let s:cpo_save=&cpo
set cpo&vim
inoremap <buffer> <silent> <BS> =AutoPairsDelete()
inoremap <buffer> <silent> § =AutoPairsMoveCharacter('''')
